package com.example.babycare.Chat.Doctor;
...
public class ChatsDoctorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chats_doctor, container, false);
    ...
    private void readChats(){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                userAdater = new UserAdater(getContext(), mUser, true);
