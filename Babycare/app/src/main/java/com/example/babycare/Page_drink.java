...
public class Page_drink  extends AppCompatActivity {
    ...
    DatabaseReference mRecipeRef = mRootRef.child("Catagories2/Drink");




    ListView listView;
    List<Model_drink> rowItems;
    ...
    public void getData() {
        mRecipeRef.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                rowItems = new ArrayList<Model_drink>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Model_drink  item = new Model_drink(recipeKey, name, calories, protein, vitamina, vitaminc, vitaminb6, vitaminb12, calcium
                            , iodine, iron);
                    rowItems.add(item);

                    Adapter_drink adapter = new Adapter_drink(getApplicationContext(), rowItems);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent newActivity = new Intent(Page_drink.this, DialogActivity_1.class);
