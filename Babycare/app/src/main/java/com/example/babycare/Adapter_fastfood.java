...
public class Adapter_fastfood extends BaseAdapter {
    Context context;
    ...
    public Adapter_fastfood(Context context, List<Model_fastfood> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_fastfood rowItem = (Model_fastfood) getItem(position);
