...
public class Page_meat  extends AppCompatActivity {
    ...
    DatabaseReference mRecipeRef = mRootRef.child("Catagories2/Meat");




    ListView listView;
    List<Model_meat> rowItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_meat);
    ...
    public void getData() {
        mRecipeRef.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                rowItems = new ArrayList<Model_meat>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Model_meat  item = new Model_meat(recipeKey, name, calories, protein, vitamina, vitaminc, vitaminb6, vitaminb12, calcium
                            , iodine, iron);
                    rowItems.add(item);

                    Adapter_meat adapter = new Adapter_meat(getApplicationContext(), rowItems);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent newActivity = new Intent(Page_meat.this, DialogActivity_1.class);
