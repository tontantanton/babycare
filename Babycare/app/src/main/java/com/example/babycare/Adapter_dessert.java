...
public class Adapter_dessert extends BaseAdapter {
    Context context;
    ...
    public Adapter_dessert(Context context, List<Model_dessert> items) {
...
// keep txtID and send to recipes list
        ...
        final Model_dessert rowItem = (Model_dessert) getItem(position);
