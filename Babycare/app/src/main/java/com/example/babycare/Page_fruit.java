...
public class Page_fruit  extends AppCompatActivity {
    ...
    DatabaseReference mRecipeRef = mRootRef.child("Catagories2/Fruit");




    ListView listView;
    List<Model_fruit> rowItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_fruit);
    ...
    public void getData() {
        mRecipeRef.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                rowItems = new ArrayList<Model_fruit>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Model_fruit  item = new Model_fruit(recipeKey, name, calories, protein, vitamina, vitaminc, vitaminb6, vitaminb12, calcium
                            , iodine, iron);
                    rowItems.add(item);

                    Adapter_fruit adapter = new Adapter_fruit(getApplicationContext(), rowItems);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent newActivity = new Intent(Page_fruit.this, DialogActivity_1.class);
