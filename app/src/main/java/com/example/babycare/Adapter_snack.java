...
public class Adapter_snack extends BaseAdapter {
    Context context;
    ...
    public Adapter_snack(Context context, List<Model_snack> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_snack rowItem = (Model_snack) getItem(position);
