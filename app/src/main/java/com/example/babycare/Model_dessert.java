...
public class Model_dessert {
    ...
    public Model_dessert() {
    }

    public Model_dessert(String calories, String id, String name, String protein,String vitamina,String vitaminac,
