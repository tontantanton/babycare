...
import com.example.babycare.Content.Upload;
...
//                            Log.d(TAG, "onSuccess: firebase download url: " + downloadUrl.toString());
                            Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),downloadUrl.toString(),mEditTextFileName.getText().toString().trim(),"");
