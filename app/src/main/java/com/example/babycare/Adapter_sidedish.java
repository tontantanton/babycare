...
public class Adapter_sidedish extends BaseAdapter {
    Context context;
    ...
    public Adapter_sidedish(Context context, List<Model_sidedish> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_sidedish rowItem = (Model_sidedish) getItem(position);
