...
public class Page_fastfood  extends AppCompatActivity {
    ...
    DatabaseReference mRecipeRef = mRootRef.child("Catagories2/Fastfood");




    ListView listView;
    List<Model_fastfood> rowItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_fastfood);
    ...
    public void getData() {
        mRecipeRef.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                rowItems = new ArrayList<Model_fastfood>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Model_fastfood  item = new Model_fastfood(recipeKey, name, calories, protein, vitamina, vitaminc, vitaminb6, vitaminb12, calcium
                            , iodine, iron);
                    rowItems.add(item);

                    Adapter_fastfood adapter = new Adapter_fastfood(getApplicationContext(), rowItems);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent newActivity = new Intent(Page_fastfood.this, DialogActivity_1.class);
