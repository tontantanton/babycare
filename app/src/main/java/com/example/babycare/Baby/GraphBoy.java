...
public class GraphBoy extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    ImageButton back;
    ArrayList<String> heightLower = new ArrayList<>();
    ArrayList<String> weightLower = new ArrayList<>();
    List<Graph> graphList = new ArrayList<>();

    private FirebaseAuth mAuth;
    private DatabaseReference userRef,myRef,myRef2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_boy);

        back = (ImageButton)findViewById(R.id.btn_back_edit);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GraphBoy.this, BabyActivity.class);
                startActivity(i);
            }
        });
...
// limit lines are drawn behind data (and not on top)
        ...
        btn_edit.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GraphBoy.this, EditProfile.class);
...
//                    h =(int)height;
                    ...
                    if(user.getImageURL().equals("default")){
                        ...
                        Glide.with(GraphBoy.this).load(user.getImageURL()).into(image_profile);
                    }

//                    final ArrayList<Entry> dataVals1 = new ArrayList<>();
//
//                    myRef = FirebaseDatabase.getInstance().getReference("BoyGraphLower");
...
//
////                    strHeight = graph.getHeight();
//                                graph.setHeight(s2[4]);
////                    heightLower.add(s5[0]);
//
//
//                                graph.setWeight(s5[0]);
////                    weightLower.add(s2[4]);
//
//                                Log.d("","h--"+Float.parseFloat(s2[4]));
//                                Log.d("","w--"+Float.parseFloat(s5[0]));
//
//                                dataVals1.add(new Entry(Float.parseFloat(s2[4]), Float.parseFloat(s5[0])));
//
//                                graphList.add(graph);
//
//
...
//                graphList.clear();
    ...
    private  ArrayList<Entry> dataValues2(){
        ...
        myRef2 = FirebaseDatabase.getInstance().getReference("BoyGraphUpper");
