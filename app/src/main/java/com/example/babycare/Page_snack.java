...
public class Page_snack  extends AppCompatActivity {
    ...
    DatabaseReference mRecipeRef = mRootRef.child("Catagories2/Snack");




    ListView listView;
    List<Model_snack> rowItems;
    ...
    public void getData() {
        mRecipeRef.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                rowItems = new ArrayList<Model_snack>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Model_snack  item = new Model_snack(recipeKey, name, calories, protein, vitamina, vitaminc, vitaminb6, vitaminb12, calcium
                            , iodine, iron);
                    rowItems.add(item);

                    Adapter_snack adapter = new Adapter_snack(getApplicationContext(), rowItems);
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent newActivity = new Intent(Page_snack.this, DialogActivity_1.class);
