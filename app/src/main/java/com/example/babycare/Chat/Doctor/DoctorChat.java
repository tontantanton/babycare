...
//        getSupportActionBar().setTitle("");
        ...
        reference = FirebaseDatabase.getInstance().getReference("Doctor").child(firebaseUser.getUid());
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (unread == 0){
                    viewPagerAdpter.addFragment(new ChatsDoctorFragment(), "แชท");
                } else {
                    viewPagerAdpter.addFragment(new ChatsDoctorFragment(), "("+unread+") แชท");
                }

                viewPagerAdpter.addFragment(new UsersChatsFragment(), "ผู้ใช้");
