...
public class Adapter_fruit extends BaseAdapter {
    Context context;
    ...
    public Adapter_fruit(Context context, List<Model_fruit> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_fruit rowItem = (Model_fruit) getItem(position);
