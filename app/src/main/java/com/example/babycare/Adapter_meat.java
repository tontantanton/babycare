...
public class Adapter_meat extends BaseAdapter {
    Context context;
    ...
    public Adapter_meat(Context context, List<Model_meat> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_meat rowItem = (Model_meat) getItem(position);
