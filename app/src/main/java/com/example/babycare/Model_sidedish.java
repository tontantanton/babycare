...
public class Model_sidedish {
    ...
    public Model_sidedish() {
    }

    public Model_sidedish(String calories, String id, String name, String protein,String vitamina,String vitaminac,
