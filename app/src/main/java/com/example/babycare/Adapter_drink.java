...
public class Adapter_drink extends BaseAdapter {
    Context context;
    ...
    public Adapter_drink(Context context, List<Model_drink> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Model_drink rowItem = (Model_drink) getItem(position);
